...
$(function() {
	...
	function getSkuId() {
        var lis = $(".theme-options li.selected");

        var skuId = "";

        lis.each(function () {

            skuId = skuId + $(this).prop("id")+";";
        ...
        $("#LikBasket").click(function () {
        	...
        	var path = "http://localhost:8080/SC/cart/addGoodsToCart";

        	var skuProperties = $("#skuId").val();
        	var buyNum = $("#text_box").val();

        	var express = $("#express").html();
			var salesPrice = $("#salesPrice").html();

			var cartId = $("#cardId").val();

			var goodsId = $("#goodsId").val();

        	$.post(path,{"skuProperties":skuProperties,"buyNum":buyNum,"express":express,"salesPrice":salesPrice,"cartId":cartId,"goodsId":goodsId},function (key) {
        		if(key == "1"){
