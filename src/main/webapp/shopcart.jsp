        ...
        <tr class="item-list">
            <div class="bundle  bundle-last ">
                ...
                <div class="bundle-main">
                  ...
                  <c:forEach var="shopOne" items="${shopcartInfoList}">
                    <ul class="item-content clearfix">
                        ...
                        <li class="td td-item">
                            <div class="item-pic">
                                <a href="#" target="_blank" data-title="美康粉黛醉美东方唇膏口红正品 持久保湿滋润防水不掉色护唇彩妆" class="J_MakePoint" data-point="tbcart.8.12">
                                    <img src="${pageContext.request.contextPath}/static/images/kouhong.jpg_80x80.jpg" class="itempic J_ItemImg"></a>
                            </div>
                            <div class="item-info">
                                <div class="item-basic-info">
                                    <a href="#" target="_blank" title="美康粉黛醉美唇膏 持久保湿滋润防水不掉色" class="item-title J_MakePoint" data-point="tbcart.8.11">${shopOne.goodsName}</a>
                                </div>
                            </div>
                        </li>
                        <li class="td td-info">
                            <div class="item-props item-props-can">
                                <c:forEach var="attributeName" items="${shopOne.attributeNameList}">
                                    <span class="sku-line">${attributeName.attrName}:${attributeName.attributeValueList[0].attrValue}</span>
                                </c:forEach>
                            ...
                            <div class="item-price price-promo-promo">
                                <div class="price-content">
                                    <div class="price-line">
                                        <em class="price-original">${shopOne.salesPrice}</em>
                                    </div>
                                    <div class="price-line">
                                        <em class="J_Price price-now" tabindex="0">${shopOne.buyNum*shopOne.price}</em>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="amount-wrapper ">
                                <div class="item-amount ">
                                    <div class="sl">
                                        ...
                                        <input class="text_box" name="" type="text" value="${shopOne.buyNum}" style="width:30px;" />
                        ...
                        <li class="td td-sum">
                            <div class="td-inner">
                                <em tabindex="0" class="J_ItemSum number">${shopOne.buyNum*shopOne.salesPrice}</em>
                            </div>
                        </li>
                        <li class="td td-op">
                            <div class="td-inner">
