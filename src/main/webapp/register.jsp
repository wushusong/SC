...
<head lang="en">
    ...
    <script>
        $(function () {
            if (${result == "注册成功"}){
                if(confirm("注册成功，请跳转至登入界面")){
                    location.href="http://localhost:8080/SC/login.jsp";
                }
            }
        })
    </script>
...
<div class="login-boxtitle">
    <a href="${pageContext.request.contextPath}/index.jsp"><img alt="" src="${pageContext.request.contextPath}/static/images/logobig.png" /></a>
</div>
            ...
            <div class="am-tabs" id="doc-my-tabs">
                ...
                <div class="am-tabs-bd">
                    <div class="am-tab-panel am-active">
                        <form action="${pageContext.request.contextPath}/register/emailOrMobel" method="post">
                            ...
                            <div class="user-pass">
                                ...
                                <input type="password" name="upwd" id="passwordMain" placeholder="设置密码">
                            </div>
                            <div class="user-pass">
                                <label for="passwordRepeat"><i class="am-icon-lock"></i></label>
                                <input type="password" name="upwds" id="passwordRepeatMain" placeholder="确认密码">
                            </div>

                        <div class="login-links">
                            <input id="reader-meMail" type="checkbox"/> 点击表示您同意商城《服务协议》
                           <!--
                            <label for="reader-me">
                            </label>
                           -->
                    ...
                    <div class="am-tab-panel">
                        <form action="${pageContext.request.contextPath}/register/emailOrMobel" method="post">
                            ...
                            <div class="user-pass">
                                <label for="passwordRepeat"><i class="am-icon-lock"></i></label>
                                <input type="password" name="upwds" id="passwordRepeat" placeholder="确认密码">
                            </div>
