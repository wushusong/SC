...
<div class="nav white">
    ...
    <div class="search-bar pr">
        ...
        <form action="${pageContext.request.contextPath}/search/searchByKey?currentPage=1" method="post">
...
<div class="search">
    <div class="search-list">
        <div class="nav-table">
            ...
            <div class="nav-cont">
                <ul>
                    <li class="index"><a href="${pageContext.request.contextPath}/index/showCategaryAll">首页</a></li>
            ...
            <div class="am-u-sm-12 am-u-md-12">
                <div class="theme-popover">
                    ...
                    <ul class="select">
                        <p class="title font-normal">
                            <span class="fl">${pageBean.key}</span>
                            <span class="total fl">搜索到<strong class="num">${pageBean.totalSize}</strong>件相关商品</span>
                        </p>
                        <div class="clear"></div>
                ...
                <div class="search-content">
                    ...
                    <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
                        <c:forEach var="goods" items="${pageBean.data}">
                                <li>
                                    <div class="i-pic limit">
                                        <img src="${goods.goodsImg}" />
                                        <a href="${pageContext.request.contextPath}/goods/goodsDetail/${goods.goodsId}">
                                            <p class="title fl">${goods.goodsName}</p>
                                        </a>
                                        <p class="price fl">
                                            <b>¥</b>
                                            <strong>${goods.salesPrice}</strong>
                                        </p>
                                        <p class="number fl">
                                            销量<span>1110</span>
                                        </p>
                ...
                <ul class="am-pagination am-pagination-right">
                    ...
                    <c:if test="${pageBean.currentPage>1 }">
                        <li><a href="${pageContext.request.contextPath}/search/searchByKey?currentPage=${pageBean.currentPage-1}&key=${pageBean.key}">&laquo;</a></li>
                    </c:if>
                    ...
                    <c:forEach begin="${1 }" end="${pageBean.totalPage }" var="i">
                        ...
                        <c:choose>
                            <c:when test="${i == pageBean.currentPage }">
                                <li class="am-active"><a href="${pageContext.request.contextPath}/search/searchByKey?currentPage=${i }&key=${pageBean.key}">${i }</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/search/searchByKey?currentPage=${i }&key=${pageBean.key}">${i }</a></li>
                            </c:otherwise>
                        </c:choose>
                    ...
                    <c:if test="${pageBean.currentPage<pageBean.totalPage }">
                        <li><a href="${pageContext.request.contextPath}/search/searchByKey?currentPage=${pageBean.currentPage+1}&key=${pageBean.key}">&raquo;</a></li>
                    </c:if>
                </ul>
