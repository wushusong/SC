...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/js/amazeui.js"></script>
        ...
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    <a href="${pageContext.request.contextPath}/static/images/01.jpg"><img src="${pageContext.request.contextPath}/static/images/01_mid.jpg" alt="细节展示放大镜特效" rel="${pageContext.request.contextPath}/static/images/01.jpg" class="jqzoom" /></a>
                </div>
                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${pageContext.request.contextPath}/static/images/01_small.jpg" mid="${pageContext.request.contextPath}/static/images/01_mid.jpg" big="${pageContext.request.contextPath}/static/images/01.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${pageContext.request.contextPath}/static/images/02_small.jpg" mid="${pageContext.request.contextPath}/static/images/02_mid.jpg" big="${pageContext.request.contextPath}/static/images/02.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${pageContext.request.contextPath}/static/images/03_small.jpg" mid="${pageContext.request.contextPath}/static/images/03_mid.jpg" big="${pageContext.request.contextPath}/static/images/03.jpg"></a>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="tb-detail-list">
                ...
                <div class="tb-detail-price">
                    <li class="price iteminfo_price">
                        <dt>促销价</dt>
                        <dd><em>¥</em><b id="salesPrice" class="sys_item_price">${goods.salesPrice}</b>  </dd>
                    </li>
                ...
                <dl class="iteminfo_parameter freight">
                    ...
                    <div class="iteminfo_freprice">
                        ...
                        <div class="pay-logis">
                            快递<b id="express" class="sys_item_freprice">10</b>元
                        </div>
                    </div>
                </dl>
                <div class="clear"></div>
                            ...
                            <div class="theme-popbod dform">
                                <form class="theme-signin" name="loginform" action="" method="post">
                                    ...
                                    <div class="theme-signin-left">
                                        ...
                                        <c:forEach var="attributeName" items="${goods.attributeNameList}">
                                        <div class="theme-options">
                                            <div class="cart-title">${attributeName.attrName}</div>
                                            <ul>
                                                <c:forEach var="attributeValue" items="${attributeName.attributeValueList}" varStatus="status">
                                                    <c:if test="${status.first}">
                                                        <li id="${attributeName.attrNameId}:${attributeValue.attrValueId}" class="sku-line selected">${attributeValue.attrValue}<i></i></li>
                                                    </c:if>
                                                    <c:if test="${!status.first}" >
                                                        <li id="${attributeName.attrNameId}:${attributeValue.attrValueId}" class="sku-line ">${attributeValue.attrValue}<i></i></li>
                                                    </c:if>
                                                </c:forEach>
                                            </ul>
                                        </div>
...
<div class="pay">
    ...
    <li>
        <div class="clearfix tb-btn tb-btn-basket theme-login">
            <input type="text" hidden="hidden" id="skuId" />
            <input type="text" hidden="hidden" value="${userInfo.cartList[0].cartId}" id="cardId">
    ...
    <div class="browse">
        <div class="mc">
            <ul>
                ...
                <li class="first">
                    <div class="p-img">
                        <a  href="#"> <img class="" src="${pageContext.request.contextPath}/static/images/browse1.jpg"> </a>
                    </div>
                ...
                <div class="am-tab-panel am-fade am-in am-active">
                    ...
                    <div class="details">
                        ...
                        <div class="twlistNews">
                            ...
                            <img src="${pageContext.request.contextPath}/static/images/tw6.jpg" />
                            <img src="${pageContext.request.contextPath}/static/images/tw7.jpg" />
                        </div>
                    </div>
                    <div class="clear"></div>
                ...
                <div class="am-tab-panel am-fade">
                    ...
                    <ul class="am-comments-list am-comments-list-flip">
                        <li class="am-comment">
                            <!-- 评论容器 -->
                            <a href="">
                                <img class="am-comment-avatar" src="${pageContext.request.contextPath}/static/images/hwbn40x40.jpg" />
                                <!-- 评论者头像 -->
                            </a>
